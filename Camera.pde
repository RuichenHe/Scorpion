...
class Camera
{
  Camera()
  {
    position      = new PVector( -296, -365, 272 ); // initial position
    theta         = -0.84; // rotation around Y axis. Starts with forward direction as ( 0, 0, -1 )
    phi           = -0.87; // rotation around X axis. Starts with up direction as ( 0, 1, 0 )
    moveSpeed     = 50;
